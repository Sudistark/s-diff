    ...
    def mount_static(ctrl, global_cfg, cfg):
        ...
        def static_resolver(section, branch, dir_path):
            ...
            if branch == 'js/i18n.js':
                ...
                return False
            elif not branch.startswith('build') and not branch.startswith('js/contrib') and not branch.startswith('js/build') and sp[1] == '.js' and os.path.exists(fn) and (splunk_home_base_dir == os.path.commonpath((splunk_home_base_dir, fn))) and 'i18noff' not in cherrypy.request.query_string:
